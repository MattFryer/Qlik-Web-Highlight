...
function qlik_highlight_ln_check()
{
    ...
    ?>
    <input type="checkbox" name="qlik_highlight_options[qlik-highlight-ln]" value="1" <?php if (isset($options['qlik-highlight-ln'])) { ?> checked
    <?php 
    } ?> />
    <strong>
    <?php
...
function qlik_highlight_cdn_check()
{
    $options = get_option('qlik_highlight_options');
    ?>
    <input type="checkbox" name="qlik_highlight_options[qlik-highlight-cdn]" value="1" <?php if (isset($options['qlik-highlight-cdn'])) { ?> checked <?php } ?> />
    <?php
...
function qlik_highlight_copy_check()
{
    $options = get_option('qlik_highlight_options');
    ?>
    <input type="checkbox" name="qlik_highlight_options[qlik-highlight-copy]" value="1" <?php if (isset($options['qlik-highlight-copy'])) { ?> checked <?php } ?> />
    <?php
...
function qlik_highlight_settings_page()
{
    ...
    <h1>
        <?php esc_html_e('Qlik for WordPress Settings', 'qlikview-syntax-highlighter'); ?>
    </h1>
    <p>
        <?php esc_html_e('The Qlik for WordPress plugin provides syntax highlighting of QlikView and Qlik Sense script in pages and post.', 'qlikview-syntax-highlighter'); ?>
    </p>
    ...
    <h2>
        <?php esc_html_e('Icons', 'qlikview-syntax-highlighter'); ?>
    </h2>
    <p>
        <?php esc_html_e('The tables below provide the necessary codes to insert QlikView and Qlik Sense icons into pages and posts:', 'qlikview-syntax-highlighter'); ?>
    </p>
    ...
    <hr />
    <p>
        <?php esc_html_e('Produced by', 'qlikview-syntax-highlighter'); ?> Matt Fryer.
        <?php esc_html_e('Further details available at', 'qlikview-syntax-highlighter'); ?> <a href="http://www.qlikviewaddict.com/p/qlikview-wordpress-plugin.html">QlikViewAddict.com</a>.
        <?php esc_html_e('Qlik is a registered trademark of QlikTech International AB', 'qlikview-syntax-highlighter'); ?>
    </p>
</div>
<?php
